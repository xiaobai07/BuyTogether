...
#ifndef BuyTogether_constants_h
#define BuyTogether_constants_h

#define kFeedObjectName @"dealObject"
#define kFeedObjectFeedNameKey @"name"
#define kFeedObjectDescriptionKey @"description"
